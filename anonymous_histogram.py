...
histogram_dir = os.path.normpath("C:/Users/Brendan/Documents/grassdata/results/anonymous/")
...
# list differences
diffs = gscript.list_grouped('rast', pattern='*diff*')['anonymous']
...
# list DEMs
dems = gscript.list_grouped('rast', pattern='*dem*')['anonymous']
