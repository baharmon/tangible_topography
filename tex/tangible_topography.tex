...
%
Stdev.~of elevation \par \vspace{0.5em} \includegraphics[width=0.19\textwidth]{images/legends/stdev_legend.pdf} & 
...
robotic fabrication, robotic construction, and real-time field data.}
