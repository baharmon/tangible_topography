...
%
GIS, however, can be unintuitive and challenging to use \cite{Ratti2004}. % more citations?
%
...
%\footnote{\url{https://grass.osgeo.org/grass72/manuals/r.series.html}}.
The mean elevation is the mean of each cell 
...
between the reference elevation and 
the linearly regressed mean elevation for each set.
%
% difference
...
with the module \textit{r.regression.line} \cite{r.regression.line}
%\footnote{\url{https://grass.osgeo.org/grass72/manuals/r.regression.line.html}}
and then calculating the difference between 
the regression 
and the mean elevation 
using map algebra 
with the module \textit{r.mapcalc} \cite{r.mapcalc}.
%\footnote{\url{https://grass.osgeo.org/grass72/manuals/r.mapcalc.html}}.
...
\begin{center}
	...
	\caption{Landforms identified by \textit{r.geomorphon}, 
		image source \cite{r.geomorphon}}
...
\begin{table}
\tbl{Coupling experiment: maps draped over a 3D rendering of the digital elevation model for each set}{
\ra{1.3}
...
%
Mean difference (ft) \par \vspace{0.5em} \includegraphics[width=0.19\textwidth]{images/legends/diff_legend.pdf} & 
\includegraphics[width=0.19\textwidth]{images/render_3d/dem_difference_1.png} &
...
%\footnote{\url{https://grass.osgeo.org/grass72/manuals/r.sim.water.html}}
