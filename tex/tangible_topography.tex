...
%\title{Tangibly modeling landscapes for performance}
%\title{Tangibly modeling landscapes}
%\title{Tangible landscape architecture}
%\title{Tangible landscape architectural Modeling}
%\title{Tangible landscape modeling}
\author{Brendan Harmon\affilnum{1,2}, Anna Petrasova\affilnum{1}, Vaclav Petras\affilnum{1}, Helena Mitasova\affilnum{1}, and Ross Meentemeyer\affilnum{1}}
