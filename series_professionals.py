...
def main():
    ...
    render = os.path.normpath("C:/Users/Brendan/Documents/grassdata/results/series_professionals/")
    ...
    for x in categories:
        for i in range(1,8):
            ...
            # list
            series = gscript.list_grouped('rast', pattern=pattern)['professionals']
